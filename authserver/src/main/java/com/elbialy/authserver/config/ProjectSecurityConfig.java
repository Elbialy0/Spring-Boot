package com.elbialy.authserver.config;
...
public class ProjectSecurityConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient oidcClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .clientSecret("{noop}dfkjkljflkdjdfklhgkjhghkgj")
        ...
        RegisteredClient authClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .clientSecret("{noop}dfkjkljflkdjsfwklhgkjhghkgj")
                ...
                .tokenSettings(TokenSettings.builder().accessTokenTimeToLive(Duration.ofMinutes(5))
                        .refreshTokenTimeToLive(Duration.ofHours(5)).reuseRefreshTokens(false)
                        .accessTokenFormat(OAuth2TokenFormat.SELF_CONTAINED).build())
                .build();
        RegisteredClient pkce = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("eazypubicclient")
                .clientSecret("{noop}dfkjkljflkdjfklhsgkjhghkgj")
        ...
        return new InMemoryRegisteredClientRepository(oidcClient,authClient,pkce);
    }
    @Bean
